    ...
    public override bool FinishedLaunching(UIApplication app, NSDictionary options)
    {
        ...
        _broadcasterService.Subscribe(nameof(AppDelegate), async (message) =>
        {
            try
            {
                ...
                {
                    App.Current.Dispatcher.Dispatch(() => ShowAppExtension((ExtensionPageViewModel)message.Data));
                }
    ...
    */
    ...
    public void InitApp()
    {
        ...
        */
        ...
        ServiceContainer.Init(deviceActionService.DeviceUserAgent, Bit.Core.Constants.ClearCiphersCacheKey,
